...
function ProductList({ onHomeClick }) {
    ...
    const handleAddToCart = (product) => {
        ...
        setAddedToCart((prevState) => ({
            ...prevState,
            [product.name]: true, // Setting name as key and true to mark as added
        }));
    };
    ...
    return (
        <div>
            ...
            {!showCart ? (
                // Task 1 REQ: Render the Plant Array inside 'product-grid' class name container
                            ...
                            <div className="product-list">
                                {category.plants.map((plant, plantIndex) => (
                                    <div className="product-card" key={plantIndex}>
                                        ...
                                        {/* Task 1 REQ: Button calls handleAddToCart and reflects disabled/changed state if added */}
                                        <button
